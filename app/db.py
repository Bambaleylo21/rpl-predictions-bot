...
async def _apply_postgres_schema_fixes(conn) -> None:
    ...
    statements = [
        ...
        "ALTER TABLE users ADD COLUMN IF NOT EXISTS custom_avatar_data TEXT",
